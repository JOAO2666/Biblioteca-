...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        categoria_ficcao = Categoria.objects.create(nome="Ficcao")
        ...
        Livro.objects.create(
            titulo="2001: Uma Odisseia no Espaco",
        ...
        Livro.objects.create(
            titulo="O Leao, a Feiticeira e o Guarda-Roupa",
            autor=autor_cs_lewis,
            categoria=categoria_fantasia,
            publicado_em="1950-10-16",
        )
